<?php 
  ...
  if(mysqli_connect_errno()){ //db연결 실패
    ...
    $strQuery = "SELECT user_id FROM user WHERE user_name = '".$decodedData['name']."' AND phone_num_first = '".$decodedData['phone_num_first']."' AND phone_num_middele = '".$decodedData['phone_num_middele']."' AND phone_num_last = '".$decodedData['phone_num_last']."'"; // 입력한 id랑 같은 id 조회
