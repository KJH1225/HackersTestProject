<?php 
  ...
  if(mysqli_connect_errno()){ //db연결 실패
    ...
    $strQuery = "SELECT userId FROM users WHERE userName = '".$decodedData['name']."' AND mailFirst = '".$decodedData['mailFirst']."' AND mailLast = '".$decodedData['mailLast']."'"; // 입력한 id랑 같은 id 조회
